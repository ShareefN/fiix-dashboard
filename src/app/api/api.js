...
const API1_URL = 'http://127.0.0.1:3020';
...
function deleteContractorReview(contractorId, reviewId) {
	return api.v1.delete({ path: `/admins/contractor/${contractorId}/review/${reviewId}` });
}

function updateUser(userId, values) {
	return api.v1.put({ path: `/admins/update/user/${userId}`, json: values });
}
