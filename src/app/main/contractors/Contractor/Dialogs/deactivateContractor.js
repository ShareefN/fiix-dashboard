...
function DeativateContractor(props) {
	...
	const submit = async model => {
		await Actions.deactivate(props.contractorId, model);
		dispatch(Actions.fetchContractor(props.contractorId));
		setDialog(false);
	};
			...
			<>
				...
				>
					<div className="flex flex-row justify-between">
						<DialogTitle id="scroll-dialog-title">Deactivate Contractor</DialogTitle>
...
export default DeativateContractor;
