...
function ActivateContractor(props) {
	...
	const submit = async model => {
		await Actions.activate(props.contractorId, model);
			...
			<>
				...
				>
					<div className="flex flex-row justify-between">
						<DialogTitle id="scroll-dialog-title">Activate Contractor</DialogTitle>
...
export default ActivateContractor;
